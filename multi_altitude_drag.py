...
skips parquet conversion and runs faster since plot_drag.py only needs .dat files
Usage: 
  python3 multi_altitude_drag.py                    # Single core (default)
  python3 multi_altitude_drag.py --cores 8          # 8 cores with mpirun
  python3 multi_altitude_drag.py -c 4               # 4 cores with mpirun
"""
...
altitudes = list(range(210, 305, 10))  # 130 to 300 km in 10 km intervals
...
for alt in altitudes:
    ...
    # Generate atmospheric data using NRLMSIS2
