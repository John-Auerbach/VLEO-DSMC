...
def _title(step):
    return f"density heatmap |z| ≤ {slice_frac:.2f}H  |  time = {step * tstep:.2e} s"
...
render_heatmap_animation(frame_imgs, outpath="outputs/grid_density_heatmap.mp4",
                         vmin=vmin, vmax=vmax, log=False, **_render_kwargs)

# optional log scale: reuses the cached frame_imgs, only re-renders/encodes
if args.log:
    render_heatmap_animation(frame_imgs, outpath="outputs/grid_density_heatmap_log.mp4",
