...
def main():
    ...
    save_animation(ani_lin, 'outputs/linearity_drag_evolution.mp4', fps=10, dpi=150)
    print('Saved outputs/linearity_drag_evolution.mp4')
    
    save_animation(ani_log, 'outputs/linearity_drag_evolution_log.mp4', fps=10, dpi=150)
